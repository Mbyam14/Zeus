...
const styles = StyleSheet.create({
  ...
  photoButton: { width: 44, height: 44, borderRadius: 22, backgroundColor: '#FFF8F0', justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: '#E1E8ED' },
  ...
  searchInput: { backgroundColor: '#FFF8F0', borderRadius: 8, paddingHorizontal: 16, paddingVertical: 12, fontSize: 16, color: '#2C3E50', borderWidth: 1, borderColor: '#E1E8ED' },
  ...
  filterPill: { paddingHorizontal: 16, paddingVertical: 8, height: 36, borderRadius: 20, backgroundColor: '#FFF8F0', borderWidth: 1, borderColor: '#E1E8ED', marginRight: 8, justifyContent: 'center', alignItems: 'center' },
  ...
  sectionHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#FFF8F0', paddingHorizontal: 16, paddingVertical: 12, borderRadius: 8, marginBottom: 12 },
  ...
  input: { backgroundColor: '#FFF8F0', borderWidth: 1, borderColor: '#E1E8ED', borderRadius: 8, paddingHorizontal: 16, paddingVertical: 12, fontSize: 16, color: '#2C3E50' },
  ...
  dropdown: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#FFF8F0', borderWidth: 1, borderColor: '#E1E8ED', borderRadius: 8, paddingHorizontal: 16, paddingVertical: 12 },
  ...
  pickerOption: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 16, borderBottomWidth: 1, borderBottomColor: '#FFF8F0' },
  ...
  dateInput: { flex: 1, backgroundColor: '#FFF8F0', borderWidth: 1, borderColor: '#E1E8ED', borderRadius: 8, paddingHorizontal: 16, paddingVertical: 12, fontSize: 18, color: '#2C3E50', textAlign: 'center', marginHorizontal: 4 },
